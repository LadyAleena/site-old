...
my $directory = '../../files/images/Fandom/Fictional_family_trees/Chuck';
...
__DATA__
These b<fictional families> were created in B<I<A<Chuck|href="../../Movies/index.pl?series=Chuck">>>. Trees are drawn if there are five or more people across two or more generations.
2 The Bartowski family
& Bartowski
2 The McHugh-Grimes family
& McHugh-Grimes
