...
I<A<Law & Order|href="Movies_by_series.pl?series=Law+&+Order">> has seven spin-offs: I<Law & Order: Special Victims Unit>, I<Law & Order: Criminal Intent>, I<Law & Order: Trial by Jury>, I<Conviction> (this series is a spin-off but is separate from the I<Law & Order> cosmology), I<Paris enquêtes criminelles>, I<Law & Order: UK>, and I<Law & Order: Los Angeles>. I<Law & Order> and its spin-offs based in New York city use the fictional newspaper The New York Ledger from I<A<Deadline|href="Movies_by_series.pl?series=Deadline">>.
...
I<The X-Files> introduced a Morley brand of cigarettes. That Morley brand of cigarettes appears in...
* I<That '70s Show> Q<Eric Gets Suspended>. I<That '70s Show> spun-off I<That '80s Show>.
* I<Malcolm in the Middle> Q<Stock Car Races>
* I<A<Special Unit 2|href="Movies_by_series.pl?series=Special+Unit+2">> Q<The Grain>
* I<A<ER|href="Movies_by_series.pl?series=ER">> "Beyond Repair". SMALL<(A<ETM|href="#ETM">)>
* I<Jake 2.0> Q<Arms and the Girl>
* I<Huff> Q<Radio Silence>
* I<A<Criminal Minds|href="Movies_by_series.pl?series=Criminal+Minds">> Q<North Mammon>. I<Criminal Minds> spun off I<Criminal Minds: Suspect Behavior>.
* I<Prison Break> Q<Bolshoi Booze> . I<Prison Break> spun-off I<Prison Break: Proof of Innocence>.
* I<A<Buffy the Vampire Slayer|href="Movies_by_series.pl?series=Buffy+the+Vampire+Slayer#Buffy_the_Vampire_Slayer_1997">>, Spike smokes them. SMALL<(A<Weyland-Yutani|href="#Weyland-Yutani">)>
* I<A<Burn Notice|href="Movies_by_series.pl?series=Burn+Notice#Burn_Notice">> Q<Scatter Point> and other episodes. I<Burn Notice> spun-off I<Burn Notice: The Fall of Sam Axe>.
* I<A<Warehouse 13|href="Movies_by_series.pl?series=Warehouse+13">> "The Ones You Love". SMALL<(A<This was Syfy's Monday nights|href="#This_was_Syfys_Monday_nights">)>
* the I<LOST> pilot.
* I<A<The Walking Dead|href="Movies_by_series.pl?series=The+Walking+Dead">> Q<Consumed>
...
Buffy Summers worked at the Double Meat Palace owned by Guy Halveston, whose murder was investigated by I<Andy Barker P.I.>
3 Red Dwarf
...
G. Callen and Sam Hannah from I<NCIS: Los Angeles> appeared on I<A<Hawaii 5-0|href="Movies_by_series.pl?series=Hawaii+Five-0#season_02">> Q<Pa Make Loa> which concluded on I<NCIS: Los Angeles> Q<Touch of Death> with Daniel Williams and Chin Ho Kelly from I<Hawaii 5-0> appearing.
