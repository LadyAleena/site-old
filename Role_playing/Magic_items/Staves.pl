...
* ^Two charges^ Monster Summoning II or Summon Lycanthrope
* ^Three charges^ Monster Summoning III, Conjure Elemental, or Summon Shadow
...
*| charges
* ^One charge^ B<Shocking Grasp> for 1d8+12 points of damage.
* ^Two charges^ B<Lightning Strike> for 6d6 points of damage with no chance of rebound.
* ^Two charges^ B<Lightning Curtain> creates a curtain of lightning in front of the wielder for 2d8+12 points of damage, 3d8+12 points of damages for anyone carrying or wearing metal, points of damage to anyone who steps through the curtain.
* ^Three charges^ B<Lightning Bolt> for 12d6 points of damage.
* ^Three charges^ B<Lightning Lash> for 12d6 points of damage with more accuracy than a lightning bolt.
* ^Four charges^ B<Lightning Storm> creates a storm of lightning, and anyone in a 70' diameter sphere will take 6d12 points of damage.
* ^Five charges^ B<Lightning Ring> creates a ring of lightning around the wielder and will discharge lightning bolts in one of three ways as listed below with each bolt doing 8d6 points of damage, and the ring will protect the wielder during this time from lightning attacks.
br
