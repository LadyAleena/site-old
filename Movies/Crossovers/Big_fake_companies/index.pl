#!/usr/bin/perl
# This is the Big fake companies index.
use strict;
...
__DATA__
When creating a crossover between two series with a A<big (or little) fake company|href="http://www.poobala.com/bfc.html" target="new">, it might be good to apply a reality check. The biggest hint the two companies are not the same is the name of the company. Companies are sticklers when it comes to the use of its company name. So no matter how close the names are, they are not the same company. Oceanic Airlines from I<Lost> would not truncate their company name on their tickets, meaning Oceanic Air from I<A<Fringe|href="Movies_by_series.pl?series=Fringe">> is not the same company. Also, mentioning B<a> paper factory in Slough on I<Lost> does not mean it is A<Wernham Hogg from I<The Office> (U.K.)|href="http://www.poobala.com/lostandoffice.html">.
...
2 Companies
B<A<Morley|href="Morley.pl">> and B<A<Oceanic Airlines|href="Oceanic_Airlines.pl">> are covered separately.
...
3 Doublemeat Palace
B<Doublemeat Palace> is a fake fast food restaraunt appearing first on I<A<Buffy the Vampire Slayer|href="../../Movies_by_series.pl?series=Buffy+the+Vampire+Slayer">> Q<Doublemeat Palace>. It was mentioned in I<Dexter> Q<Truth Be Told> and used again in I<A<Andy Barker, P.I.|href="../../Movies_by_series.pl?series=Andy+Barker,+P.I.">> Q<Fairway, My Lovely>.
...
3 Lariat
B<Lariat> is several fake car rental companies which can be used when a real company can not be. The use of Lariat does not constitute a crossover because of name and logo mismatches. 
* A<I<The X-Files>|href="../../Movies_by_series.pl?series=The+X-Files#The_X-Files_1993">
...
B<The Montecito Resort and Casino> is a fake hotel and casino featured in I<Las Vegas>. Other NBC series used The Montecito.
* I<A<Las Vegas|href="../../Movies_by_series.pl?series=Las+Vegas">>
* I<Passions> (20 and 23 May 2005)
* I<A<Medium|href="../../Movies_by_series.pl?series=Medium">> Q<Method to His Madness>
* I<A<Heroes|href="../../Movies_by_series.pl?series=Heroes">> Q<Collision>
* I<A<Knight Rider|href="../../Movies_by_series.pl?series=Knight+Rider#Knight_Rider_2008_film">> (2008 film)
3 Nozz-a-la Cola
...
* I<Alias> Q<It Begins>
* I<A<Heroes|href="../../Movies_by_series.pl?series=Heroes">> Q<Cautionary Tales> and Q<Truth or Consequences>
* I<Cloverfield>
* I<A<Fringe|href="../../Movies_by_series.pl?series=Fringe">> Q<The Road Not Taken> and Q<A Better Human Being>
* I<A<Star Trek|href="../../Movies_by_series.pl?series=Star+Trek#Star_Trek_2009">> (2009)
* I<Super 8>
...
* I<Airport>
* I<All My Children>
* I<Emergency> Q<The Girl on the Balance Beam> SMALL<(A<Drag a big net|href="Westphall_non-crossovers.pl#Drag_a_big_net">)>
* I<Quincey M.E.>
* I<Matlock> SMALL<(A<Lucy's Diagnosis|href="Westphall_crossovers.pl#Lucys_Diagnosis">)>
* I<The Young and the Resless>
* I<Miami Vice>
I am still working on the other connections.
3 Weyland-Yutani
B<Weyland-Yutani> is a fake mulinational conglomerate appearing first in I<Aliens>. Joss Whedon included this company in his other works.  (I am still waiting to see if Weyland-Yutani appears in the Marvel Cinematic Universe.)
* I<A<Alien|href="../Movies_by_series.pl?series=Alien">>
* I<A<Angel|href="../Movies_by_series.pl?series=Buffy+the+Vampire+Slayer#Angel">> Q<Harm's Way>
* I<A<Firefly|href="../Movies_by_series.pl?series=Firefly#Firefly">> Q<Serenity>
