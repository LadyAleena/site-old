...
my %foods = (
  ...
  'Klondike bar flavors' => [ map( ucfirst "$_ Klondike bar", ('original', 'dark chocolate', 'double chocolate', 'neopolitan', 'mint chocolate chip', 'rocky road', 'cookie dough swirl', 'brownie fudge swirl', 'caramel pretzel', 's\'mores', 'Oreo', 'Reese\'s', 'Krunch', 'Heath'))],
