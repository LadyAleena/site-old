...
C<fancy_split> is exported by default and returns a referenced array split by a user specified amount. It takes two paraments: the size of the groups and the string to be split. The size can be any whole number.
