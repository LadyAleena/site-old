...
my @images = ('All in the Families', 'Hawaii Five', 'Hooterville', 'I Love Lucy', 'Leave It to Beaver', 'legend');
my $doc_magic;
for (@images) {
  (my $image = $_) =~ s/ /_/g;
  my $link = "../files/images/Movies/$image.png";
  $doc_magic->{$_} = sub { print anchor( img({ 'src' => $link, 'alt' => $_ }), { 'href' => $link, 'class' => 'inline' }) };
}
...
I<Friends> Q<The One Where Rachel Smokes> and I<Seinfeld> Q<The Invitations> show the same brand of Morley cigarettes, however, they are not the same as I<The X-Files> Morley brand.
...
Melville's restaurant above Cheers was mentioned on I<Boston Legal> SMALL<(ABC)>.
3 The Practice
...
Doctor Mark Craig from I<St. Elsewehere> received the Cushing Left Anterior Descending Artery Award as did a character on I<Chicago Hope>. He also made a minor mention of the I<A<M*A*S*H|href="Movies_by_series.pl?series=MASH#MASH_1972">> character Dr. B. J. Hunnicut. I<M*A*S*H> had three spin-offs I<A<AfterMASH|href="Movies_by_series.pl?series=MASH#AfterMASH">>, I<A<W*A*L*T*E*R|href="Movies_by_series.pl?series=MASH#WALTER">>, and I<The Fighting Nightingales>. I<Trapper John, M.D.> is a spin off of I<MASH>, the film, not the television series.
...
While the character Detective John Munch was on I<A<Homicide: Life on the Street|href="Movies_by_series.pl?series=Homicide">> there were three crossovers with I<A<Law & Order|href="Movies_by_series.pl?series=Law+%26+Order#Law_&_Order">>. I<Law & Order> Q<Charm City> continues in I<Homicide: Life on the Street> Q<For God and Country>. I<Homicide: Life on the Street> is followed by I<Law & Order> in the episodes Q<Baby, It's You> and Q<Sideshow> on both series. Detective John Munch tranferred to I<A<Law & Order: Special Victims Unit|href="Movies_by_series.pl?series=Law+%26+Order#Law_&_Order:_Special_Victims_Unit">>. I<A<Law & Order|href="Movies_by_series.pl?series=Law+%26+Order">> has seven more spin-offs. I<Law & Order> and its spin-offs based in New York city use the fictional newspaper The New York Ledger from I<A<Deadline|href="Movies_by_series.pl?series=Deadline">>.
Detective John Munch has appeared on I<The Beat> Q<They Say It's Your Birthday>, I<Arrested Development> Q<Exit Strategy>, I<The Wire> Q<Took>, and I<The X-Files> Q<Unusual Suspects>. SMALL<(A<The X-Files|href="#The_X-Files">)> In I<Luther>'s fifth episode of the first season, John Luther mentions John Munch of I<Law & Order: Special Victims Unit>.
...
Deputy Marshall Mary Shannon from I<A<In Plain Sight|href="Movies_by_series.pl?series=In+Plain+Sight">> appeared on I<Law & Order: Criminal Intent> Q<Contract>.
Nicole Wallace, a recurring character on I<Law & Order: Criminal Intent>, appeared on I<Jo> under an assumed name. She is identified by her fingerprints.
...
3 The X-Files
from FOX and CBS
I<A<The X-Files|href="Movies_by_series.pl?series=The+X-Files#The_X-files_1993">> Q<Red Museum> took place in the town of Delta Glen. I<Picket Fences> Q<Away In A Manger> contains a reference to the town and events of Q<Red Museum>.
In I<Strange Luck> Q<Struck by Lightning>, the character of Chance Harper's brother mentions Fox Mulder of I<The X-Files>.
In I<The X-Files> Q<Milagro> the graveyard is seen where the characters Nicholas and Diane Salinger are buried from I<Party of Five>. I<Party of Five> has one spin-off, I<Time of Your Life>.
Frank and Jordan Black from I<A<Millennium|href="Movies_by_series.pl?series=Millennium">> appear in I<The X-Files> Q<Millennium>.
I<The Lone Gunmen> spun off of I<The X-Files> along with two films and a revival miniseries.
...
Mr. Roper from I<Three's Company> appeared on I<Ellen> Q<Roommates>. I<Three's Company> had two spin-offs I<The Ropers> and I<Three's A Crowd>. I<Three's Company> is a non-contiguous spin-off of I<Man About the House> which has two spin-offs, I<George and Mildred> and I<Robin's Nest>.
3 The Drew Carey Show
from ABC, NBC, CBS, and UPN
...
Dana Foster from I<Step by Step> meets Cory on I<Boy Meets World> Q<The Happiest Show On Earth>. I<Boy Meets World> spun off I<Girl Meets World>.
...
I<Meego> Q<Mommy 'n' Meego> crossed with I<Gilligan's Island>.
...
3 Happy Days
from ABC
I<Happy Days> had five spin-offs I<Laverne & Shirley>, I<Blansky's Beauties>, I<Mork & Mindy>, I<Out of the Blue>, and I<Joanie Loves Chachi>. I<Happy Days> spun-off from an episode of the anthology series I<Love, American Style>. I<Love, American Style> had one spin-off I<The New Love, American Style>.
2 Morley cigarettes
from FOX
...
* Warrick Brown from I<CSI: Crime Scene Investigation> smokes Morley cigarettes. (CBS) SMALL<(A<CSI: Crime Scene Investigation|href="#CSI:_Crime_Scene_Investigation">)>
...
* I<A<Warehouse 13|href="Movies_by_series.pl?series=Warehouse+13">> "The Ones You Love". (SyFy) SMALL<(A<This was Syfy's Monday nights|href="#This_was_Syfys_Monday_nights">)>
...
3 This was Syfy's Monday nights
from SyFy
Anyone who watches the Syfy channel knows that on Monday nights they aired three television series I<A<EurSUP<e>ka|href="Movies_by_series.pl?series=EWA#EUReKA">>, I<A<Warehouse 13|href="Movies_by_series.pl?series=EWA#Warehouse_13">>, and I<A<Alphas|href="Movies_by_series.pl?series=EWA#Alphas">>. Some might not be aware that these three series have formed a crossover cosmology.
Let’s look at the three crossovers between I<Eureka> and I<Warehouse 13>. The first crossover between the two is I<Warehouse 13> Q<13.1>. The second crossover is I<Eureka> Q<Crossing Over>. The third crossover is I<Warehouse 13> Q<Don’t Hate the Player>. The two series are now indelibly linked.
...
3 Lost in Alias
from ABC
I<LOST> had two minor crossovers with I<Alias>. The first was the fictional band called Driveshaft who were introduced on I<LOST>, but had a minor mention on I<Alias> "Authorized Personnel Only" part 2. In I<Alias> "A Clean Conscience", the flight which got lost in I<LOST> was mentioned.
I<Alias> introduced a fictional bank named Credit Dauphine which appeared on I<Eli Stone> "The Path".
3 Breaking Dead
from AMC
...
A<I'm not home!|href="#Im_not_home"> OMG! A<Holy defenestration, Batman!|href="#Holy_defenestration_Batman">
& Hooterville
2 Leave It to Beaver to cross over
from CBS, ABC, Disney Channel, FOX, NBC, and The WB
I<Leave It to Beaver> spun off I<Still the Beaver> which was renamed I<The New Leave It to Beaver>. Eddie Haskell from I<Leave it to Beaver> appeared on I<Parker Lewis Can’t Lose> Q<Father Knows Less>. Andrew Keaton of I<Family Ties> appeared on I<Parker Lewis Can’t Lose> Q<Civil Wars>. Bud Bundy of I<Married with Children> appeared on I<Parker Lewis Can’t Lose> Q<Musso & Frank>.
...
from CBS
I<The Mary Tyler Moore Show> spun off four series. I<Rhoda> was first, then I<Phyllis>, then I<Lou Grant>, and then I<Mary and Rhoda>. SMALL<(A<I'm not home!|href="Im_not_home">)>
3 <i>Columbo</i>
from NBC and ABC
I<Columbo> spun off I<Mrs. Columbo>. I<Mrs. Columbo> went through a lot of name changes: first was to I<Kate Columbo>, next was to I<Kate the Detective>, and when the show ended it was I<Kate Loves a Mystery>.
3 <i>Burke's Law</i>
from ABC and CBS
...
* I<My Mother the Car>
* I<The Brady Bunch> and the people of A<Hooterville|href="#Hooterville">.
