...
Doctor Mark Craig from I<St. Elsewehere> received the Cushing Left Anterior Descending Artery Award as did a character on I<Chicago Hope>. He also made a minor mention of the I<A<M*A*S*H|href="Movies_by_series.pl?series=MASH#MASH_1972">> character Dr. B. J. Hunnicut. I<M*A*S*H> had two spin-offs I<A<AfterMASH|href="Movies_by_series.pl?series=MASH#AfterMASH">>, and I<A<W*A*L*T*E*R|href="Movies_by_series.pl?series=MASH#WALTER">>. I<Trapper John, M.D.> is a spin off of I<MASH>, the film, not the television series.
...
3 The X-Files
from FOX and CBS
I<A<The X-Files|href="Movies_by_series.pl?series=The+X-Files#The_X-files_1993">> Q<Red Museum> took place in the town of Delta Glen, and I<Picket Fences> Q<Away In A Manger> contains a reference to the town and events of Q<Red Museum>. In I<Strange Luck> Q<Struck by Lightning>, the character of Chance Harper's brother mentions Fox Mulder of I<The X-Files>. In I<The X-Files> Q<Milagro> the graveyard is seen where the characters Nicholas and Diane Salinger are buried from I<Party of Five>. I<Party of Five> has one spin-off, I<Time of Your Life>. Frank and Jordan Black from I<A<Millennium|href="Movies_by_series.pl?series=Millennium">> appear in I<The X-Files> Q<Millennium>. I<The Lone Gunmen> spun off of I<The X-Files> along with two films.
...
* I<A<ER|href="Movies_by_series.pl?series=ER">> "Beyond Repair". SMALL<(A<ETM|href="#ETM">)> (NBC)
...
* I<A<Warehouse 13|href="Movies_by_series.pl?series=Warehouse+13">> "The Ones You Love". SMALL<(A<This was Syfy's Monday nights|href="#This_was_Syfys_Monday_nights">)> (SyFy)
* I<LOST> "LA X" (ABC)
* I<Californication> "The Raw & the Cooked" (Showtime)
* I<A<The Walking Dead|href="Movies_by_series.pl?series=The+Walking+Dead">> Q<Consumed> (AMC)
* Warrick Brown from I<CSI: Crime Scene Investigation> smokes Morley cigarettes. SMALL<(A<CSI: Crime Scene Investigation|href="#CSI:_Crime_Scene_Investigation">)> (CBS)
3 ETM
from NBC
...
3 Red Dwarf
from NBC, UPN, BBC One, BBC Two, BBC Three, CBBC, and ITV
...
The following cosmologies may all be connected through the I<Los Angeles Tribune>, the fictional newspaper from I<Lou Grant>.
...
3 The crossover
I<Columbo>, I<A<Wonder Woman|href="Movies_by_series.pl?series=Wonder+Woman+(1975)">>, I<A<Matt Houston|href="Movies_by_series.pl?series=Matt+Houston">>, I<A<Remington Steele|href="Movies_by_series.pl?series=Remington+Steele">>, I<A<Moonlighting|href="Movies_by_series.pl?series=Moonlighting">>, I<City of Angels>, I<Burke's Law> (1994), and I<24> allegedly read the I<Los Angeles Tribune> from I<Lou Grant>. I have no proof of A<this crossover|href="http://tommywestphall.livejournal.com/25863.html">, however with the amount of networks involved and no discernible connections, I do not see this as a crossover. 
2 <i>Babylon 5</i>
...
Now we're A<going to Hawaii|href="#Going_to_Hawaii">.
2 <i>JAG</i> and <i>NCIS</i>
from CBS and NBC
